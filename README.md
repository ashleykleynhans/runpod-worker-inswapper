...
Serverless worker for face swapping using
[FaceFusion](https://github.com/facefusion/facefusion) swapper models
(including inswapper) with [InsightFace](https://insightface.ai/)
face detection.

![Tests](https://img.shields.io/github/actions/workflow/status/ashleykleynhans/runpod-worker-inswapper/build-docker-image.yml?style=for-the-badge&label=Tests)
![Python](https://img.shields.io/badge/Python-3.12-%233776ab?style=for-the-badge&logo=python&logoColor=white)
![License](https://img.shields.io/github/license/ashleykleynhans/runpod-worker-inswapper?style=for-the-badge&color=%23673ab7)
