...
### Changed
- Bump protobuf from 7.36.1 to 7.36.2
...
### Fixed
- Revert Runpod Hub GPU pool to AMPERE_24,ADA_24 (non-Blackwell), keeps RTX 4090 coverage via ADA_24 while removing extra 48/80 pools
...
### Fixed
- Downgrade onnxruntime from 1.30.0 to 1.29.0 for CUDA 12.4 compatibility (1.30.0 requires CUDA 13 and fails with libcublasLt.so.13 missing)
